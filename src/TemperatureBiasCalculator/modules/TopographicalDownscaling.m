function SNAP_Downscaled = TopographicalDownscaling(AllStationData, SNAP_Rect)
    %%
    ...
    %}
    SNAP_Rect_Rot = GetRotatedGrid(SNAP_Rect)
...
function [SNAP_Rect_Rot, Xdown, Ydown] = GetRotatedGrid(SNAP_Rect)
