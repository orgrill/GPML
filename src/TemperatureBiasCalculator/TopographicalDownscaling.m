function [CWS_SNAP_Downscaled, FitDays, FitSet, TestSet] = TopographicalDownscaling(AllStationData, CWS_SNAP_Rect, SNAP_Rect_Rot, StationX, Xdown, Ydown)
    %%
    ...
    load(fullfile("data", "CWS_SNAP_Fine.mat"));
